        ...
        <LayoutPanel region="north" :border="false">
            <Panel :bodyStyle="{padding:'8px'}" :border="false">
                ...
                <ButtonGroup selectionMode="single" class="m-l-30">
                    <LinkButton :toggle="true" :selected="!outstock" @click="changeStatus(false)">未出库</LinkButton>
                    <LinkButton :toggle="true" :selected="outstock" @click="changeStatus(true)">已出库</LinkButton>
                </ButtonGroup>
        ...
        <LayoutPanel region="center" style="height:100%" bodyCls="f-column" :border="false">
            ...
            <Dialog ref="pickinglistDlg" closed
                        ...
                        <LayoutPanel region="center" style="height:100%;padding-top: 10px" :border="false">
                            <DataGrid v-if="pickinglistObj.children"
                                ...
                                <GridColumn field="warehouseid" title="出货仓库" align="center">
                                    <template slot="body" slot-scope="scope">
                                        <div class="item">
                                            <span v-if="pickinglistObj.outstock">{{ scope.row.warehousename }}</span>
                                            <select v-if="!pickinglistObj.outstock" class="w-100" v-model="scope.row.warehouseid" @change="changeWarehouse(scope.row)">
                ...
                <div class="dialog-button text-center">
                    <LinkButton style="width:80px" v-if="!pickinglistObj.outstock" @click="outbound">出库</LinkButton>
                    <LinkButton style="width:80px" @click="$refs.pickinglistDlg.close()">关闭</LinkButton>
                </div>
            </Dialog>
        </LayoutPanel>
    </Layout>
